...
export class Padlead2Dsp {
    ...
    init(sample_rate: i32): void {
        Padlead2Dsp.classInit(sample_rate);
...
export class Padlead2 extends MidiVoice {
    readonly dsp: Padlead2Dsp = new Padlead2Dsp();
    ...
    typedChannel!: Padlead2Channel;

    constructor(channel: MidiChannel) {
        super(channel);
        this.typedChannel = changetype<Padlead2Channel>(changetype<usize>(channel));
...
export class Padlead2EffectDsp {
    fSampleRate: i32;
    fHslider1: f32;
    fSlow0: f32;
    fHslider2: f32;
    ...
    init(sample_rate: i32): void {
        Padlead2EffectDsp.classInit(sample_rate);
        this.instanceInit(sample_rate);
    }
    control(): void {
...
export class Padlead2Channel extends MidiChannel {
    ...
    readonly effectDsp: Padlead2EffectDsp = new Padlead2EffectDsp();
...
export function initializeMidiSynth(): void {
    midichannels[0] = new Padlead2Channel(10, (channel: MidiChannel) => new Padlead2(channel));
